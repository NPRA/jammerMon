...
class EVK8N:
    ...
    def _setup_device(self, device_port, baudrate, timeout):
        ...
        self._device.configure_port(
            port=ublox.PORT_SERIAL1, inMask=1, outMask=0)
        self._device.configure_port(port=ublox.PORT_USB, inMask=1, outMask=1)
        self._device.configure_port(
            port=ublox.PORT_SERIAL2, inMask=1, outMask=0)
        self._device.configure_poll_port()
        ...
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_POSLLH, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_STATUS, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV, ublox.MSG_NAV_SOL,
                                            1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_VELNED, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_SVINFO, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_VELECEF, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_POSECEF, 1)
        self._device.configure_message_rate(ublox.CLASS_RXM, ublox.MSG_RXM_RAW,
                                            1)
        self._device.configure_message_rate(ublox.CLASS_RXM,
                                            ublox.MSG_RXM_SFRB, 1)
        self._device.configure_message_rate(ublox.CLASS_RXM,
                                            ublox.MSG_RXM_SVSI, 1)
        self._device.configure_message_rate(ublox.CLASS_RXM, ublox.MSG_RXM_ALM,
                                            1)
        self._device.configure_message_rate(ublox.CLASS_RXM, ublox.MSG_RXM_EPH,
                                            1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_TIMEGPS, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_TIMEUTC, 1)
        self._device.configure_message_rate(ublox.CLASS_NAV,
                                            ublox.MSG_NAV_CLOCK, 5)
        # self._device.configure_message_rate(ublox.CLASS_NAV, ublox.MSG_NAV_DGPS, 5)

        self._device.configure_message_rate(ublox.CLASS_MON, ublox.MSG_MON_HW,
                                            1)
...
class FakeEVK8N:
    ...
    def gen_test_messages():
        ...
        m1.fields = {
            ...
            'reserved1': 132,
            'usedMask': 125951,
            'VP': [10, 11, 12, 13, 14, 15, 1, 0, 2, 3, 255, 16, 255, 18, 19, 54, 53],
            'jamInd': 6,
            'reserved3': [239, 92],
            'pinInq': 0,
            'pullH': 128896,
